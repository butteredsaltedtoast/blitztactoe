...
# Default to SECURE settings (production-safe)
# Set ALLOW_INSECURE_LOCAL=True to disable security for local testing
ALLOW_INSECURE_LOCAL = os.environ.get("ALLOW_INSECURE_LOCAL", "False") == "True"
...
ASGI_APPLICATION = 'ttt.asgi.application'
